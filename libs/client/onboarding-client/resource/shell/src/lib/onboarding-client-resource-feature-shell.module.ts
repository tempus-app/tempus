...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				canActivate: [AuthGuard],
				loadChildren: () =>
					import('@tempus/client/onboarding-client/resource/features/feature-view-timesheet').then(
						m => m.ClientOnboardingClientResourceFeaturesFeatureViewTimesheetModule,
					),
			},
		],
	},
