...
export class AddPasswordResetDetails1668625483896 implements MigrationInterface {
    name = 'AddPasswordResetDetails1668625483896'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."password_reset_entity_status_enum" AS ENUM('VALID', 'INVALID')`);
        await queryRunner.query(`CREATE TABLE "password_reset_entity" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "expiry" TIMESTAMP NOT NULL, "status" "public"."password_reset_entity_status_enum" array NOT NULL, "userId" integer, CONSTRAINT "PK_7481a83d8311ff76a0cdced20a8" PRIMARY KEY ("id"))`);
